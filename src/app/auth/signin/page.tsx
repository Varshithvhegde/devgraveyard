...
function SignInContent() {
  ...
  return (
    <div className="min-h-screen bg-grave-950 flex items-center justify-center">
      <div className="text-center space-y-6 max-w-md px-6">
        <div className="text-7xl mb-4">⚰️</div>
        <h1 className="font-gothic text-4xl text-bone">
          Connect GitHub
        </h1>
        <p className="text-zinc-400 text-lg">
          We need to see your repositories to know which ones to bury.
        </p>
        <button
